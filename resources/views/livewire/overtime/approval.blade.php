...
new class extends Component {
    ...
    /**
     * Mengambil data pengajuan lembur untuk ditampilkan.
     */
    public function with(): array
    {
        $query = OvertimeRequest::with('employee.branch');
...
<div class="px-6 py-4">
    ...
    @can('admin')
        <x-table :headers="['NIP', 'Nama Karyawan', 'Cabang', 'Tanggal Lembur', 'Alasan', 'Aksi']" :rows="$requests" emptyMessage="Tidak ada pengajuan lembur yang perlu disetujui."
    ...
    @else
        <x-table :headers="['NIP', 'Nama Karyawan', 'Tanggal Lembur', 'Alasan', 'Aksi']" :rows="$requests" emptyMessage="Tidak ada pengajuan lembur yang perlu disetujui."
            fixedHeader="true" maxHeight="540px">
            @foreach ($requests as $request)
                <x-table.row>
                    <x-table.cell class="font-mono">
